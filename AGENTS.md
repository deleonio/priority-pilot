...
— plus ein Done-Label nur, wo Logik es liest: `ai:needs-analyse` (oder Issue neu bzw. `ai:analysed`
entfernt) → Analyse → `ai:analysed` + `ai:needs-ux-ui` (UI) bzw. `ai:needs-spec` (Nicht-UI) → UX →
...
| ----------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------- |
| **Triage**        | Issue neu, `ai:needs-analyse` gesetzt, `ai:analysed` entfernt | [ticket-triage.md](.ai-knowledge/ticket-triage.md)                                                     | Analyse-Body-Block + Ampel → `ai:analysed` (+ `ai:needs-ux-ui` bei 🟢+UI, `ai:needs-spec` bei 🟢+Nicht-UI) |
