...
1. `KolTableStateful` mit `_label="Liste der erledigten Aufgaben"` (Screenreader), `_data`, `_headers` (horizontal), `_fixedCols={[1,1]}` — fixiert Titel (erste) und Aktion (letzte) Spalte beim internen horizontalen Scrollen.
...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| AK1 | `CompletedTasksTable` rendert `KolTableStateful` (`_label="Liste der erledigten Aufgaben"`, `_fixedCols={[1,1]}`) **statt** der nativen `table.completed-tasks-table`. Header: „Titel", je Säule gekürzter Name (**≤ 20 Zeichen**, ≠ voller Name falls länger), „Aktion".                                                                                                                                    |
