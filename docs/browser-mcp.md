...
- **CI:** Playwright-MCP ist in den Phasen UX (02), Umsetzung (04) und Fixup (06) via `browser-mcp: true`
  ...
  und starten die Inspect-Instanz im Hintergrund (`nohup ./ui-inspect.sh` mit Readiness-Check auf http://localhost:4174,
  Timeout 120s). Die anderen Phasen (01 Triage, 03 Spec, 05 Review) nutzen nur KoliBri-MCP; Documenter (07) hat keinen
