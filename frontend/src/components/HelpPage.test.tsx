...
describe('HelpPage – #1206: Kategorien-Aggregation und klickbare Links', () => {
	...
	// Markdown-Fremdlink, AK1), v0.1.694 mit Bug Fixes + Other Changes.
	// New Features/Improvements/Engineering fehlen bewusst — leere Kategorien dürfen
	// nicht erscheinen (AK2). Führender HTML-Kommentar wie bei echten Release-Bodys.
	...
	it('AK3: Kein Eintrag geht verloren — li-Gesamtzahl = Bullet-Summe; Ursprungs-Version je Bullet sichtbar', async () => {
		...
		// Bullet-Summe der Fixture-Bodys: 695 = 3 (Export, Absturz, #1204), 694 = 2 (Fehler, Aufräumarbeiten).
		expect(lis, 'Anzahl Einträge = Summe aller Bullets').toHaveLength(5);
