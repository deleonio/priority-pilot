...
export const buildBalancePriorities = (
	...
	// Defizit je Säule: Soll-Anteil minus Ist-Anteil, gemessen am Soll (nDefizit aus find.ts).
 ...
 * sonst stabil (keine Gleichstands-Umsortierung). Das Eingabe-Array wird nicht mutiert. Tasks ohne
 * Eintrag in `priorities` zählen als Score 0 (neutral).
 */
