...
/**
 * #222: Homogenerer App-Header — die E-Mail-Adresse wurde am #933 aus dem Header entfernt;
 * der Avatar wurde ebenfalls entfernt.
 */
describe('App — Homogenerer Header (#222)', () => {
	...
	// Der Avatar wurde am #933 entfernt, kein Smoke-Test mehr nötig.
});

/**
 * #912: Der Avatar wurde am #933 aus dem Header entfernt.
 */
// tests removed
