 ...
 * Icon-Asset `/logo/logo.png` (bereits in `frontend/public/logo/` vorhanden). Die Navigation zum
 * Dashboard läuft seit der Home-Schalter-Umstellung nicht mehr über das Logo, sondern über den
 * ersten Button der Kopf-Aktionen-Toolbar (siehe `issue-1334-home-schalter.spec.ts`).
 */
test.describe('#485 Header – Icon-Only-Logo', () => {
	/**
	 * AK1 — Logo nur als Icon: Das img im Logo referenziert das reine Icon-Asset
