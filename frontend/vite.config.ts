...
// Achtung: Die Wurzelpfade sind hier als Allowlist gepflegt (siehe openapi.yml: /tasks, /forest,
// /next) — kommt im Vertrag ein neuer Wurzelpfad hinzu, muss er hier ergänzt werden.
