...
// /forest, /next, /suggestions) — kommt im Vertrag ein neuer Wurzelpfad hinzu, muss er hier ergänzt
// werden. Wird sowohl für den Dev-Server als auch für `vite preview` verwendet, damit in beiden
// Modi kein CORS auftritt.
const apiProxy = {
	'^/(tasks|pillars|forest|next|suggestions)': {
