...
- Lebensbalance auf dem Dashboard: sieben wählbare Bilder desselben Ergebnisses („Zifferblätter“, `docs/zifferblatt-konzept.md`) — Herz-Gefäß, Blasen, Scheiben, Ringe, Strahlen, Blüte, Kristall. Je Säule dieselbe Kennzahl (Ist ÷ Soll, ungedeckelt), außen ein Zifferblatt aus 100 Strichen für die Gesamt-Balance. WebGL2 mit vollwertigem SVG-Rückfall; Reduced-Motion-Präferenz wird respektiert, kein JS-Render-Loop.
