...
REVIEW TARGET (read it all yourself):
  1. CI prompts: all files under .github/prompts/ — phase prompts (triage, ux, spec, implement, fixup, review, documenter), memory snippets (memory-read.md, memory-write.md), and the nightly helper prompts (adr-sync, mentor, code-review-team, spec-sync, guide-sync, prompt-audit).
