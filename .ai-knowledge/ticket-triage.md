...
Slash-Commands (z. B. für Hermes Agent unter `.hermes/commands/`) verweisen nur auf diese Schritte.
...
- Sind Sub-Issues sofort umsetzbar (Ampel 🟢), zusätzlich `ai:spec-ready` setzen — entweder direkt
  ...
  gemergt ist**: [`hermes-issue-unblock.yml`](../.github/workflows/hermes-issue-unblock.yml) entfernt
